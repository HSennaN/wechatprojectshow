...
<br><form id="form" name="form1" method="post" action="words1action.jsp">
 <label for="textfield" style="margin-left:25px;">part1文字更改</label> <br><br>
 <textarea style="margin: 0px 0px 0px 25px; width: 629px; height: 265px;" width:100%;="" name="w1" width="680px" height="200px" max-width="680px" max-height="200px" bordercolor="#FFffff"></textarea>
