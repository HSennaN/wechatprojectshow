...
<br><form id="form" name="form2" method="post" action="words2action.jsp">
 <label for="textfield" style="margin-left:25px;">part2文字更改</label> <br><br>
 <textarea style="margin: 0px 0px 0px 25px; width: 629px; height: 265px;" width:100%;="" name="w2" width="680px" height="200px" max-width="680px" max-height="200px" bordercolor="#FFffff"></textarea>
