...
<br><form id="form" name="form4" method="post" action="words4action.jsp">
 <label for="textfield" style="margin-left:25px;">part4文字更改</label> <br><br>
 <textarea style="margin: 0px 0px 0px 25px; width: 629px; height: 265px;" width:100%;="" name="w4" width="680px" height="200px" max-width="680px" max-height="200px" bordercolor="#FFffff"></textarea>
